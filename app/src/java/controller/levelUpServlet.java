...
public class levelUpServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String requestUserID = (String) request.getParameter("userID");
            int delta = Integer.parseInt(request.getParameter("delta")) * -1;
            String skillType = request.getParameter("skillType");
            DateTime requestTimestamp = DateTime.now();            
            if(!transactionDAO.levelUp(requestStaffID,requestUserID,delta,skillType,requestTimestamp)){
